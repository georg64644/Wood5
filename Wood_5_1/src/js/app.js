...
/* Бегающие счетчики */
// import "./files/digits-counter.js"
...
import * as dgFunction from "./myJs/myJs.js";

/* Функция маски для телефонов */
// dgFunction.maskPhone();

/*Выравнивание высоты блоков*/
// Передать общий класс элементов для выравнивания
// dgFunction.heightBlockFunc(elemClass);


/* Функция копирования значения из input*/
// dgFunction.copyCode();

/* функция проставляет id для [data-agree] и его label на странице*/
// dgFunction.chekboxId();

/* функция Проверяем нажат ли чекбокс и блокирует кнопку отправки*/
// dgFunction.checkboxChecking();

/* Удаляем лишнее для ссылок на телефон */
// dgFunction.clearLinkPhone();
