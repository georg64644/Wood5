...
class Popup {
    constructor(options) {
        let config = {
            ...
            classes: {
                ...
                fancyBoxArea: 'fancybox__container',  // Класс главной обертки плагина
            },
    ...
    eventsPopup() {
        ...
        document.addEventListener("click", function (e) {
            ...
            if (buttonClose || !e.target.closest(`.${this.options.classes.fancyBoxArea}`) && !e.target.closest(`.${this.options.classes.popupContent}`) && this.isOpen) {
    ...
    close(selectorValue) {
        ...
        if (!this._reopen) {
            ...
            !this.bodyLock ? bodyUnlock() : bodyUnlock();
            this.isOpen = false;
        }
